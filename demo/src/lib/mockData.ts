...
export const MOCK_ASSETS: Asset[] = [
  // Pharmacy 1 (ph1)
  { id: 'a1', code: 'TS-001', name: 'Máy tính quầy 1', category: 'Thiết bị IT', type: 'Máy tính', pharmacyId: 'ph1', location: 'Quầy thu ngân', status: 'active', originalCost: 12000000, depreciationMonths: 36, installDate: '2024-01-15', responsibleUserId: 'u5', totalRepairCost: 0 },
  { id: 'a2', code: 'TS-002', name: 'Màn hình quầy 1', category: 'Thiết bị IT', type: 'Màn hình', pharmacyId: 'ph1', location: 'Quầy thu ngân', status: 'active', originalCost: 4500000, depreciationMonths: 36, installDate: '2024-01-15', responsibleUserId: 'u5', totalRepairCost: 0 },
  { id: 'a3', code: 'TS-003', name: 'Máy in hóa đơn', category: 'Thiết bị IT', type: 'Máy in', pharmacyId: 'ph1', location: 'Quầy thu ngân', status: 'needs_repair', originalCost: 3200000, depreciationMonths: 36, installDate: '2024-01-15', responsibleUserId: 'u5', totalRepairCost: 500000 },
  { id: 'a4', code: 'TS-004', name: 'Điều hòa Daikin 12000BTU', category: 'Điện lạnh', type: 'Điều hòa', pharmacyId: 'ph1', location: 'Khu vực bán hàng', status: 'active', originalCost: 15000000, depreciationMonths: 60, installDate: '2023-06-01', responsibleUserId: 'u5', totalRepairCost: 1200000 },
  { id: 'a5', code: 'TS-005', name: 'Kệ trưng bày thuốc A', category: 'Nội thất', type: 'Kệ', pharmacyId: 'ph1', location: 'Khu vực bán hàng', status: 'active', originalCost: 8500000, depreciationMonths: 60, installDate: '2023-03-10', responsibleUserId: 'u5', totalRepairCost: 0 },
  { id: 'a6', code: 'TS-006', name: 'Kệ trưng bày thuốc B', category: 'Nội thất', type: 'Kệ', pharmacyId: 'ph1', location: 'Khu vực bán hàng', status: 'active', originalCost: 8500000, depreciationMonths: 60, installDate: '2023-03-10', responsibleUserId: 'u5', totalRepairCost: 0 },
  { id: 'a7', code: 'TS-007', name: 'Camera an ninh - Cửa chính', category: 'An ninh', type: 'Camera', pharmacyId: 'ph1', location: 'Cửa chính', status: 'active', originalCost: 2800000, depreciationMonths: 36, installDate: '2023-06-01', responsibleUserId: 'u5', totalRepairCost: 0 },
  ...
  { id: 'a12', code: 'TS-012', name: 'Điều hòa Samsung 18000BTU', category: 'Điện lạnh', type: 'Điều hòa', pharmacyId: 'ph2', location: 'Khu vực bán hàng', status: 'needs_repair', originalCost: 18500000, depreciationMonths: 60, installDate: '2023-04-20', responsibleUserId: 'u6', totalRepairCost: 800000 },
  { id: 'a13', code: 'TS-013', name: 'Kệ trưng bày thuốc', category: 'Nội thất', type: 'Kệ', pharmacyId: 'ph2', location: 'Khu vực bán hàng', status: 'active', originalCost: 8500000, depreciationMonths: 60, installDate: '2023-04-20', responsibleUserId: 'u6', totalRepairCost: 0 },
  ...
  { id: 'a19', code: 'TS-019', name: 'Điều hòa Panasonic 12000BTU', category: 'Điện lạnh', type: 'Điều hòa', pharmacyId: 'ph3', location: 'Khu vực bán hàng', status: 'active', originalCost: 14000000, depreciationMonths: 60, installDate: '2024-03-01', responsibleUserId: 'u7', totalRepairCost: 0 },
  ...
  { id: 'a24', code: 'TS-024', name: 'Máy tính quầy 2', category: 'Thiết bị IT', type: 'Máy tính', pharmacyId: 'ph4', location: 'Quầy tư vấn', status: 'active', originalCost: 12000000, depreciationMonths: 36, installDate: '2024-01-20', responsibleUserId: 'u10', totalRepairCost: 0 },
  ...
  { id: 'a29', code: 'TS-029', name: 'Kệ trưng bày', category: 'Nội thất', type: 'Kệ', pharmacyId: 'ph5', location: 'Khu vực bán hàng', status: 'inactive', originalCost: 8500000, depreciationMonths: 60, installDate: '2023-06-01', responsibleUserId: 'u10', totalRepairCost: 0 },
  { id: 'a30', code: 'TS-030', name: 'Điều hòa Daikin 12000BTU', category: 'Điện lạnh', type: 'Điều hòa', pharmacyId: 'ph5', location: 'Khu vực bán hàng', status: 'inactive', originalCost: 15000000, depreciationMonths: 60, installDate: '2023-06-01', responsibleUserId: 'u10', totalRepairCost: 0 },

  // Admin assets (ph1 - HQ) - phụ trách bởi Nguyễn Văn An (u1)
  { id: 'a44', code: 'TS-044', name: 'Tủ rack server & UPS', category: 'Thiết bị IT', type: 'Server', pharmacyId: 'ph1', location: 'Phòng server HQ', status: 'active', originalCost: 85000000, depreciationMonths: 60, installDate: '2023-01-10', responsibleUserId: 'u1', totalRepairCost: 0 },
  { id: 'a45', code: 'TS-045', name: 'Laptop quản lý Dell XPS 15', category: 'Thiết bị IT', type: 'Máy tính', pharmacyId: 'ph1', location: 'Văn phòng quản lý', status: 'active', originalCost: 32000000, depreciationMonths: 36, installDate: '2024-01-05', responsibleUserId: 'u1', totalRepairCost: 0 },
  { id: 'a46', code: 'TS-046', name: 'Máy in văn phòng HP LaserJet', category: 'Thiết bị IT', type: 'Máy in', pharmacyId: 'ph1', location: 'Văn phòng quản lý', status: 'active', originalCost: 8500000, depreciationMonths: 36, installDate: '2024-01-05', responsibleUserId: 'u1', totalRepairCost: 0 },
];
...
export const MOCK_TASKS: Task[] = [
  { id: 'task1', code: 'TASK-001', incidentId: 'inc1', assetId: 'a3', pharmacyId: 'ph1', title: 'Sửa máy in hóa đơn - NT Nguyễn Trãi', description: 'Máy in kẹt giấy, cần kiểm tra và sửa chữa gấp.', status: 'in_progress', level: 1, assigneeId: 'u3', creatorId: 'u5', solution: 'self_repair', estimatedCost: 200000, actualCost: 0, laborCost: 150000, materialCost: 50000, supervisionCost: 0, responseSla: '2026-03-28T09:30:00Z', completionSla: '2026-03-28T16:30:00Z', slaStatus: 'at_risk', createdAt: '2026-03-28T08:30:00Z', updatedAt: '2026-03-28T10:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task2', code: 'TASK-002', incidentId: 'inc2', assetId: 'a9', pharmacyId: 'ph1', title: 'Thay máy quét mã vạch - NT Nguyễn Trãi', description: 'Máy quét hỏng cần thay thế.', status: 'accepted', level: 2, assigneeId: 'u3', creatorId: 'u5', solution: 'replace_parts', estimatedCost: 800000, actualCost: 0, laborCost: 200000, materialCost: 600000, supervisionCost: 0, responseSla: '2026-03-27T18:00:00Z', completionSla: '2026-03-29T14:00:00Z', slaStatus: 'on_time', createdAt: '2026-03-27T14:00:00Z', updatedAt: '2026-03-27T15:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task3', code: 'TASK-003', incidentId: 'inc3', assetId: 'a12', pharmacyId: 'ph2', title: 'Kiểm tra điều hòa - NT Lê Văn Sỹ', description: 'Điều hòa không mát, cần kiểm tra gas và vệ sinh.', status: 'pending', level: 2, assigneeId: null, creatorId: 'u6', solution: null, estimatedCost: 0, actualCost: 0, laborCost: 0, materialCost: 0, supervisionCost: 0, responseSla: '2026-03-29T14:00:00Z', completionSla: '2026-03-31T10:00:00Z', slaStatus: 'overdue', createdAt: '2026-03-29T10:00:00Z', updatedAt: '2026-03-29T10:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task4', code: 'TASK-004', incidentId: 'inc4', assetId: 'a14', pharmacyId: 'ph2', title: 'Thông bồn rửa tay - NT Lê Văn Sỹ', description: 'Bồn rửa tay bị tắc cần thông.', status: 'waiting_confirmation', level: 2, assigneeId: 'u4', creatorId: 'u6', solution: 'outsource', estimatedCost: 300000, actualCost: 250000, laborCost: 120000, materialCost: 80000, supervisionCost: 50000, responseSla: '2026-03-20T13:00:00Z', completionSla: '2026-03-22T09:00:00Z', slaStatus: 'on_time', createdAt: '2026-03-20T09:00:00Z', updatedAt: '2026-03-21T16:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task5', code: 'TASK-005', incidentId: 'inc5', assetId: 'a21', pharmacyId: 'ph3', title: 'Sửa bảng hiệu LED - NT CMT8', description: 'Bảng hiệu LED nhấp nháy, cần kiểm tra mạch.', status: 'in_progress', level: 3, assigneeId: 'u4', creatorId: 'u7', solution: 'self_repair', estimatedCost: 500000, actualCost: 0, laborCost: 350000, materialCost: 150000, supervisionCost: 0, responseSla: '2026-03-30T11:00:00Z', completionSla: '2026-04-01T07:00:00Z', slaStatus: 'on_time', createdAt: '2026-03-30T07:00:00Z', updatedAt: '2026-03-30T10:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task6', code: 'TASK-006', incidentId: 'inc6', assetId: 'a26', pharmacyId: 'ph4', title: 'Xử lý rò rỉ ống nước - NT HBT', description: 'Ống nước rò rỉ khu vệ sinh, cần xử lý gấp.', status: 'in_progress', level: 1, assigneeId: 'u3', creatorId: 'u10', solution: 'outsource', estimatedCost: 2000000, actualCost: 0, laborCost: 1000000, materialCost: 700000, supervisionCost: 300000, responseSla: '2026-03-31T07:00:00Z', completionSla: '2026-03-31T14:00:00Z', slaStatus: 'overdue', createdAt: '2026-03-31T06:00:00Z', updatedAt: '2026-03-31T08:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task7', code: 'TASK-007', incidentId: 'inc7', assetId: 'a4', pharmacyId: 'ph1', title: 'Kiểm tra tiếng ồn điều hòa - NT Nguyễn Trãi', description: 'Điều hòa có tiếng ồn lạ khi vận hành.', status: 'completed', level: 2, assigneeId: 'u4', creatorId: 'u5', solution: 'self_repair', estimatedCost: 500000, actualCost: 400000, laborCost: 300000, materialCost: 100000, supervisionCost: 0, responseSla: '2026-03-15T15:00:00Z', completionSla: '2026-03-17T11:00:00Z', slaStatus: 'on_time', createdAt: '2026-03-15T11:00:00Z', updatedAt: '2026-03-16T14:00:00Z', completedAt: '2026-03-16T14:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
  { id: 'task8', code: 'TASK-008', assetId: 'a25', pharmacyId: 'ph4', title: 'Bảo dưỡng điều hòa - NT HBT', description: 'Vệ sinh và bảo dưỡng định kỳ điều hòa.', status: 'pending', level: 3, assigneeId: null, creatorId: 'u10', solution: null, estimatedCost: 0, actualCost: 0, laborCost: 0, materialCost: 0, supervisionCost: 0, responseSla: '2026-04-01T13:00:00Z', completionSla: '2026-04-03T09:00:00Z', slaStatus: 'on_time', createdAt: '2026-03-31T09:00:00Z', updatedAt: '2026-03-31T09:00:00Z', beforeImages: [], duringImages: [], afterImages: [] },
];
...
export const MOCK_TRANSFERS: TransferRecord[] = [
  {
    ...
    performedById: 'u1',
    status: 'completed',
    notes: 'Tài sản đã được bàn giao và ghi nhận tại NT Hai Bà Trưng',
    approvedById: 'u2',
    approvedAt: '2025-11-09T10:00:00Z',
    recipientConfirmed: true,
    recipientConfirmedById: 'u10',
    recipientConfirmedAt: '2025-11-10T15:30:00Z',
    recipientNotes: 'Đã nhận và kiểm tra tài sản, tình trạng tốt.',
  },
  {
    id: 'tr2',
    code: 'BG-001',
  ...
  },
  {
    ...
    performedById: 'u2',
    status: 'completed',
    notes: 'Bộ phận vận hành sẽ theo dõi và báo cáo tiến độ sửa chữa',
    approvedById: 'u1',
    approvedAt: '2025-09-14T09:00:00Z',
  },
  {
    id: 'tr4',
    code: 'DC-002',
  ...
  },
  {
    ...
    notes: 'Đang chờ xác nhận tiếp nhận từ bộ phận vận hành',
    approvedById: 'u1',
  ...
  },
  {
    ...
    performedById: 'u1',
    status: 'draft',
    notes: 'Chờ xác nhận từ quản lý nhà thuốc ph2 trước khi thực hiện',
  },
];
